	...
	const values = [
		{
			...
			description: 'We build training platforms and tools that help enterprise IT teams develop their skills effectively.'
		},
		{
			icon: 'M13 10V3L4 14h7v7l9-11h-7z',
			title: 'Innovation Driven',
			description: 'Constantly exploring new technologies and methodologies to deliver effective enterprise IT learning experiences.'
		},
		{
			icon: 'M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z',
			title: 'Knowledge Sharing',
			description: 'Committed to elevating the industry through training, documentation, and open-source contributions.'
		}
	];
		...
		<div class="grid lg:grid-cols-2 gap-12 items-center">
			<div>
				...
				<div class="space-y-4 text-muted-foreground">
					...
					<p>
						Teller Technologies was born from the belief that quality enterprise IT training, planning, and documentation tools shouldn't be gatekept. We're building tools that make professional development accessible and effective.
					</p>
					<p>
		...
		<div class="flex flex-wrap justify-center gap-4">
			{#each industries as industry (industry.name)}
				<div class="card p-6 text-center hover:border-accent-brand/30 transition-colors group w-40 sm:w-48">
					...
					<h3 class="text-sm font-medium text-white">{industry.name}</h3>
				</div>
			{/each}
		</div>
	</div>
	...
	<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
		<div class="max-w-2xl mx-auto text-center">
			...
			<a
				...
				class="inline-flex items-center gap-2 px-6 py-3 rounded-lg bg-[#0A66C2] text-white font-medium hover:bg-[#004182] transition-colors"
			>
